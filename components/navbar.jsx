...
const Navbar = () => {
  return (
    <div className="bg-[#15132B] w-full h-[12vh] flex items-center justify-evenly px-4">
      <div className="bg-[#211A75] rounded-full flex items-center px-2 py-4 w-[25vw]">
        <FaSearch className="h-5 w-5 text-[#7879F1] ml-4 mr-3" />
        <input
          type="text"
          placeholder="Search here"
          className="bg-[#211A75] text-[13px] text-[#AAAAAA] outline-none placeholder-[#AAAAAA] w-24 sm:w-32 md:w-40"
        />
      </div>
      ...
      <button className="text-white flex space-x-3 bg-[#211A75] py-4 px-3 font-semibold rounded-full text-sm">
        <div className="mr-2">
          <img src={us} />
        </div>
        <p>ENGLISH</p>
